...
def theta_call_stdlib(s: float, k: float, r: float, sigma: float, t: float, q: float, d1: float = None, d2: float = None, trading_days: int = None):
    """
    Calculates the theta of a european option call, whose underlying pays a continuous dividend yield q, using the Python standard library
...
def theta_call_vector(s: np.array, k: np.array, r: np.array, sigma: np.array, t: np.array, q: np.array, d1: np.array = None, d2: np.array = None, trading_days: int = None):
    """
    Calculates the theta of a european option call, whose underlying pays a continuous dividend yield q, using numpy & scipy for speed & vectorized operations
    Returns the yearly Theta, divide by number of days to get daily theta
...
def theta_put_stdlib(s: float, k: float, r: float, sigma: float, t: float, q: float, d1: float = None, d2: float = None, trading_days: int = None):
    """
    Calculates the theta of a european option put, whose underlying pays a continuous dividend yield q, using the Python standard library
    Returns the yearly Theta, divide by number of days to get daily theta
...
def theta_put_vector(s: np.array, k: np.array, r: np.array, sigma: np.array, t: np.array, q: np.array, d1: np.array = None, d2: np.array = None, trading_days: int = None):
    """
    Calculates the theta of a european option put, whose underlying pays a continuous dividend yield q, using numpy & scipy for speed & vectorized operations
    Returns the yearly Theta, divide by number of days to get daily theta
...
def rho_call_stdlib(s: float, k: float, r: float, sigma: float, t: float, q: float, d1: float = None, d2: float = None):
    """
    Calculates the rho of a european option call, whose underlying pays a continuous dividend yield q, using the Python standard library
...
def rho_call_vector(s: np.array, k: np.array, r: np.array, sigma: np.array, t: np.array, q: np.array, d1: np.array = None, d2: np.array = None):
    """
    Calculates the rho of a european option call, whose underlying pays a continuous dividend yield q, using numpy & scipy for speed & vectorized operations
    Divide by 100 to get the rho as option price change for 1%
...
def rho_put_stdlib(s: float, k: float, r: float, sigma: float, t: float, q: float, d1: float = None, d2: float = None):
    """
    Calculates the rho of a european option put, whose underlying pays a continuous dividend yield q, using the Python standard library
    Divide by 100 to get the rho as option price change for 1%
...
def rho_put_vector(s: np.array, k: np.array, r: np.array, sigma: np.array, t: np.array, q: np.array, d1: np.array = None, d2: np.array = None):
    """
    Calculates the rho of a european option put, whose underlying pays a continuous dividend yield q, using numpy & scipy for speed & vectorized operations
    Divide by 100 to get the rho as option price change for 1%
...
print(rho_call_stdlib(220,220,0,0.25,1,0))
print(rho_call_vector(220,220,0,0.25,1,0))
print(rho_stdlib(220,220,0,0.25,1,0,flag="c"))
print(rho_vector(220,220,0,0.25,1,0,flag="c"))

print(rho_put_stdlib(220,220,0,0.25,1,0))
print(rho_put_vector(220,220,0,0.25,1,0))
print(rho_stdlib(220,220,0,0.25,1,0,flag="p"))
print(rho_vector(220,220,0,0.25,1,0,flag="p"))